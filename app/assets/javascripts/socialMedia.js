...
//Validar documento, configurar
 $("#form").validate({
    ...
    messages: {
        RedSocial: "Debe escribir una red social",
...
var table = $("#TablaSocialMedia").shieldGrid({
            dataSource: {
                events: {
            ...
            columns: [
                ...
                { field: "name", title: "Social Media", width: "80px" },
                {
                    width: 140,
                    title: " ",
                    buttons: [
    ...
    function WriteResponse(data) {        
            ...
            $.each(data, function (index, data) {                        
              ...
              alert(data.IdRedSocial),
              alert(data.RedSocial)
              alert(data.Estatus)
            });
    }
     ...
     function GuardarRedSocial() {        
      ...
      $.ajax({
        ...
        success: function(msg) {
          ...
          var table = $('#TablaSocialMedia').dataTable();
...
// ========== FUNCIONES PARA MENSAJE DE CONFIRMACION ================
  ...
  function ConfirmGuardar() {     
     bootbox.dialog({
  message: "¿Esta seguro de guardar esta Red Social?",
  title: "Confirmación",
  buttons: {
     danger: {
    ...
    success: {
     ...
     bootbox.dialog({
  message: "¿Esta seguro de modificar esta Red Social?",
  title: "Confirmación",
  buttons: {
     danger: {
      label: "No estoy seguro",
    ...
    success: {
     ...
     bootbox.dialog({
  message: "¿Esta seguro de Eliminar esta red social?",
  title: "Confirmación",
  buttons: {
     danger: {
      label: "No estoy seguro",
